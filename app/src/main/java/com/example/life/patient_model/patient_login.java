//package com.example.life.patient_model;
//
...
// jo page iske baad ayega usko rakhna h main activity ki jagah
        }
    }
    ...
    private boolean isPasswordValid(@NonNull String text) {
        if (text.length() > 7 && text.length() < 14) {
            ...
            passwordTextInput.setError("Password must conatin between 8 to 13 characters");
            return false;
        }
    }
